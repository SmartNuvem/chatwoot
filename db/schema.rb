...
ActiveRecord::Schema[7.1].define(version: 2026_07_06_000000) do
  ...
  create_table "inboxes", id: :serial, force: :cascade do |t|
    ...
    t.boolean "resolved_message_enabled"
    t.text "resolved_message_text"
    t.boolean "auto_resolve_inactive_conversations_enabled"
    t.integer "auto_resolve_inactive_conversations_minutes"
  ...
  create_table "webhook_inboxes", force: :cascade do |t|
    t.bigint "webhook_id", null: false
    t.integer "inbox_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["inbox_id"], name: "index_webhook_inboxes_on_inbox_id"
    t.index ["webhook_id", "inbox_id"], name: "index_webhook_inboxes_on_webhook_id_and_inbox_id", unique: true
  end
  ...
  add_foreign_key "webhook_inboxes", "inboxes"
  add_foreign_key "webhook_inboxes", "webhooks"
